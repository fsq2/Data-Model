...
def process_log_file(cur, filepath):
    ...
    # insert time data records
        ...
        t['hour'] = t.ts.dt.hour
        t['day'] = t.ts.dt.day
        t['dayofweek'] = t.ts.dt.dayofweek
        t['month'] = t.ts.dt.month
        t['year'] = t.ts.dt.year
        t['weekday'] = t.ts.dt.weekday
        time_df = t[['ts','hour','day','dayofweek','month','year','weekday']]
        clomnm = ['start_time','hour','day','week','month','year','weekday']
        time_df.columns = clomnm
