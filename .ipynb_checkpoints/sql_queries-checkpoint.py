...
CREATE TABLE IF NOT EXISTS
 songplays(songplay_id SERIAL PRIMARY KEY not null, start_time timestamp not null  , 
user_id varchar not null, level varchar, song_id varchar not null, artist_id varchar not null,
...
# INSERT RECORDS
# insert in songplay add conflict when the user change thier level  
...
""")
#INSERT IN USER TABLE AND ADD CONFLICT 
